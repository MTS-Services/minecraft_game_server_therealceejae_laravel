    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            @if ($user->two_factor_recovery_codes !== null)
                <p>
                    <a data-bs-toggle="collapse" href="#codesCollapse" role="button" aria-expanded="false"
                        aria-controls="codesCollapse">
                ...
                <div class="collapse" id="codesCollapse">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <a href="{{ route('profile.2fa.codes') }}" class="btn btn-primary"
                                download="{{ $codesBackupName }}">

...
/***/ "./node_modules/@adminkit/core/node_modules/bootstrap/dist/js/bootstrap.esm.js":
/*!*************************************************************************************!*\
  !*** ./node_modules/@adminkit/core/node_modules/bootstrap/dist/js/bootstrap.esm.js ***!
  \*************************************************************************************/
...
/***/ "./node_modules/@adminkit/core/src/js/modules/bootstrap.js":
/*!*****************************************************************!*\
  !*** ./node_modules/@adminkit/core/src/js/modules/bootstrap.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var bootstrap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! bootstrap */ "./node_modules/@adminkit/core/node_modules/bootstrap/dist/js/bootstrap.esm.js");
...
/***/ "./node_modules/@adminkit/core/src/js/modules/sidebar.js":
/*!***************************************************************!*\
  !*** ./node_modules/@adminkit/core/src/js/modules/sidebar.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const initializeSimplebar = () => {
  ...
  if(simplebarElement){
    const simplebarInstance = new simplebar__WEBPACK_IMPORTED_MODULE_0__["default"](document.getElementsByClassName("js-simplebar")[0]);
...
/***/ "./node_modules/@adminkit/core/src/js/modules/theme.js":
/*!*************************************************************!*\
  !*** ./node_modules/@adminkit/core/src/js/modules/theme.js ***!
  \*************************************************************/
/***/ (() => {
...
var isPossiblePrototype = __webpack_require__(/*! ../internals/is-possible-prototype */ "./node_modules/simplebar/node_modules/core-js/internals/is-possible-prototype.js");
...
/***/ "./node_modules/simplebar/node_modules/core-js/internals/array-slice.js":
/*!******************************************************************************!*\
  !*** ./node_modules/simplebar/node_modules/core-js/internals/array-slice.js ***!
  \******************************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./node_modules/simplebar/node_modules/core-js/internals/function-uncurry-this-accessor.js":
/*!*************************************************************************************************!*\
  !*** ./node_modules/simplebar/node_modules/core-js/internals/function-uncurry-this-accessor.js ***!
  \*************************************************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./node_modules/simplebar/node_modules/core-js/internals/is-possible-prototype.js":
/*!****************************************************************************************!*\
  !*** ./node_modules/simplebar/node_modules/core-js/internals/is-possible-prototype.js ***!
  \****************************************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
var arraySlice = __webpack_require__(/*! ../internals/array-slice */ "./node_modules/simplebar/node_modules/core-js/internals/array-slice.js");
...
var uncurryThisAccessor = __webpack_require__(/*! ../internals/function-uncurry-this-accessor */ "./node_modules/simplebar/node_modules/core-js/internals/function-uncurry-this-accessor.js");
var isObject = __webpack_require__(/*! ../internals/is-object */ "./node_modules/simplebar/node_modules/core-js/internals/is-object.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _adminkit_core_src_js_modules_bootstrap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @adminkit/core/src/js/modules/bootstrap */ "./node_modules/@adminkit/core/src/js/modules/bootstrap.js");
/* harmony import */ var _adminkit_core_src_js_modules_sidebar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @adminkit/core/src/js/modules/sidebar */ "./node_modules/@adminkit/core/src/js/modules/sidebar.js");
/* harmony import */ var _adminkit_core_src_js_modules_theme__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @adminkit/core/src/js/modules/theme */ "./node_modules/@adminkit/core/src/js/modules/theme.js");
/* harmony import */ var _adminkit_core_src_js_modules_theme__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_adminkit_core_src_js_modules_theme__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! axios */ "./node_modules/axios/lib/axios.js");
/* harmony import */ var petite_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! petite-vue */ "./node_modules/petite-vue/dist/petite-vue.es.js");
...
(0,petite_vue__WEBPACK_IMPORTED_MODULE_4__.createApp)().mount();
...
document.querySelectorAll('[data-theme-value]').forEach(function (el) {
  el.addEventListener('click', function (ev) {
    ...
    document.querySelectorAll('[data-theme-value]').forEach(function (child) {
      var childTheme = child.getAttribute('data-theme-value');
      if (childTheme === theme) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_3__["default"].post(el.href, {
      theme: theme
    });
  });
});
...
document.querySelectorAll('[data-image-preview]').forEach(function (el) {
  el.addEventListener('change', function (e) {
    if (el.files && el.files[0]) {
      ...
      var preview = document.getElementById(el.dataset['imagePreview']);
...
document.querySelectorAll('[data-clipboard-target]').forEach(function (el) {
  ...
  el.addEventListener('click', function (ev) {
    ...
    navigator.clipboard.writeText(el.innerText).then(function () {
      var message = el.dataset['copied'];
      if (el.tooltip && message) {
        var oldTitle = el.dataset['bsOriginalTitle'];
...
window.createAlert = function (color, message, dismiss) {
  var button = dismiss ? ' <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>' : '';
  var icon;
  switch (color) {
    case 'success':
      icon = 'check-circle';
  ...
  document.getElementById('status-message').innerHTML = '<div class="alert alert-' + color + ' alert-dismissible fade show" role="alert">' + icon + message + button + '</div>';
};
var readNotifications = document.getElementById('readNotifications');
var readingNotifications = false;
if (readNotifications) {
  readNotifications.addEventListener('click', function (ev) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_3__["default"].post(readNotifications.getAttribute('href')).then(function () {
...
/******/ 		var installedChunks = {
/******/ 			"/vendor/admin": 0,
/******/ 			"vendor/bootstrap-icons/bootstrap-icons": 0,
/******/ 			"vendor/admin": 0
/******/ 		};
/******/ 		
...
/******/ 	__webpack_require__.O(undefined, ["vendor/bootstrap-icons/bootstrap-icons","vendor/admin"], () => (__webpack_require__("./resources/js/admin/admin.js")))
/******/ 	__webpack_require__.O(undefined, ["vendor/bootstrap-icons/bootstrap-icons","vendor/admin"], () => (__webpack_require__("./resources/sass/admin/admin.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor/bootstrap-icons/bootstrap-icons","vendor/admin"], () => (__webpack_require__("./node_modules/bootstrap-icons/font/bootstrap-icons.scss")))

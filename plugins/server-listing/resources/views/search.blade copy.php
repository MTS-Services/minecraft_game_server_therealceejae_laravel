    ...
    <div class="container py-5">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('server-listing.search') }}">Minecraft Server Search</a>
                </li>
                                ...
                                <div class="mobile-server-row">
                                    <div class="mobile-server-card">
                                        <div class="mobile-server-header">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    <div class="simple-server-badge me-2" style="background: #ffc107;">
                                                        <i class="bi bi-star-fill text-white"></i>
                                                        <span class="fw-bold">#{{ $index + 1 }}</span>
                                                    </div>
                                                    <h6 class="mb-0 text-white"><i
                                                            class="bi bi-server me-1"></i>{{ __('Server') }}</h6>
                                                </div>
                                                <span class="badge status-badge {{ $sList->is_online ?: 'offline' }}">
                                                    <i
        ...
        @else
            <div class="card server-card">
                <div class="card-body">
                    <div class="server-row" style="border: none">
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="text-center">

...
@section('title', trans('server-listing::admin.tag.title'))
...
@push('footer-scripts')
    ...
    <script>
        ...
        function updateOrder() {
            axios.post('{{ route('server-listing.admin.tags.update-order') }}', {
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <ol class="list-unstyled sortable sortable-list mb-2" id="sortable">
                <li class="default-item">
                    <div class="card">
                        <div class="card-body row ">
                            ...
                            <span class="col">
                                {{ trans('server-listing::messages.fields.slug') }}
                            </span>
                            <span class="col">
                ...
                @foreach ($tags as $tag)
                    <li class="sortable-item  sortable-parent" data-id="{{ $tag->id }}">
                        <div class="card">
                            <div class="card-body row ">
                                <span class="col">
                                ...
                                <span class="col">
                                    <span class="{{ $tag->status_bg }}">
                                        {{ $tag->status_label }}
                                    </span>
                                </span>
                                <span class="col-1">
                                    <a href="{{ route('server-listing.admin.tags.edit', $tag->slug) }}" class="m-1"
                                        title="{{ trans('server_listing::messages.actions.edit') }}"
                                        data-bs-toggle="tooltip"><i class="bi bi-pencil-square"></i></a>
                                    <a href="{{ route('server-listing.admin.tags.destroy', $tag->slug) }}" class="m-1"
                                        title="{{ trans('server_listing::messages.actions.delete') }}"

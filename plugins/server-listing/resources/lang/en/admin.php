...
return [
    ...
    'server' => [
        ...
        'port' => 'Server Port',
        'icon' => 'Server Icon',
        'icon_info' => 'The icon must be a square image, preferably 64x64 pixels.',
        'description' => 'Server Description',
        'category' => 'Server Category',
        'category_info' => 'The category of the server, used to group servers together.',
        'website' => 'Website URL',
        'discord' => 'Discord URL',
        ...
        'tags' => 'Tags',
        'tags_info' => 'Tags are used to categorize servers, they can be used to filter servers in the server listing.',
        'banner' => 'Server Banner',
        'banner_info' => 'The banner must be a rectangular image, preferably 1200x300 pixels.',
        'logo' => 'Server Logo',
        'logo_info' => 'The logo must be a square image, preferably 256x256 pixels.',
        'sort_order' => 'Sort Order',
        'sort_order_info' => 'The sort order is used to order the servers in the server listing. The lower the number, the higher the server will be displayed.',
        'last_ping' => 'Last Ping',
        'last_ping_info' => 'The last time the server was pinged to check if it is online.',
    ...
    'permissions' => [
        ...
        'packages' => 'Manage minecraft server listing packages and categories',
        'gateways' => 'Manage minecraft server listing  payment gateways',
        'promotions' => 'Manage minecraft server listing  coupons and discounts',
        'giftcards' => 'Manage minecraft server listing  gift cards',
        'payments' => 'Create and view minecraft server listing  payments/purchases and subscriptions',
    ],
    ...
    'coupons' => [
        ...
        'global' => 'Should the coupon be active on all the server listing?',
    ...
    'discounts' => [
        ...
        'global' => 'Should the discount be active on all the server listing?',
        'active' => 'Active',
    ...
    'settings' => [
        'title' => 'Server Listing settings',
        'enable_home' => 'Enable the server listing home page',
        'home_message' => 'Home message',
        'use_site_money' => 'Enable purchases with the site currency.',
        'use_site_money_info' => 'When enabled, the packages in the server listing can only be purchased with website money. In order for users to credit their account, you can set up offers in the server listing.',
        ...
        'terms_info' => 'Links in Markdown format, for example: <code>I accept the [terms of service](https://example.com/terms) of the server listing.</code>',
    ],
